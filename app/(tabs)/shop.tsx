...
import { View, Text, ScrollView, Animated, Image, ImageBackground, TouchableOpacity, TextInput, LayoutAnimation, UIManager, Platform , Modal, Vibration, Alert, Linking, Pressable, Share, FlatList } from 'react-native';
